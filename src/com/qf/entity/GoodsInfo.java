...
public class GoodsInfo {
	...
	public GoodsInfo(Integer id, String goods_name, String goods_description, String goods_pic, Double goods_price,
			Integer goods_stock, Double goods_price_off, Double goods_discount, Integer goods_parentid,
			Integer goods_fatherid) {
		this.id = id;
		this.goods_name = goods_name;
		this.goods_description = goods_description;
		this.goods_pic = goods_pic;
