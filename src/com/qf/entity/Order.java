...
public class Order {
	private Integer id;
	private String o_sendtype;  //发送方式
	private String o_paytype;   //支付方式
	private Double o_paycount;  //金额
	private Date o_orderdate;  //订单日期
	private Integer userid;
	private String o_shperson;  //收货人
	private String o_shphone;   //电话
	private String o_shaddress;  //发货地址
