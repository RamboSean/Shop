...
<script type="text/javascript">
	$(function(){
		...
		$("#add").click(function(){
			var value = $("#value").val();   
			var stock = $("#stock").html();  //取库存
			if(value!=stock){ //如果值不到库存数量则继续加
				value = parseInt(value)+1;  //做加法运算要确保都为整数
				$("#value").val(value);
			}
		})
		...
		$("#toShoppingCart").click(function(){
			...
			param.id = id;
			param.count = count;
			$.get("ShoppingServlet?action=toShoppingCart",param,function(data){
				location.reload();  //刷新
			})
		})
	})
				...
				<div class="pay">
					...
					<li>
						<div class="clearfix tb-btn tb-btn-basket theme-login">
							<a id="toShoppingCart" title="加入购物车" href="#"><i></i>加入购物车</a>
						</div>
					</li>
				</div>
