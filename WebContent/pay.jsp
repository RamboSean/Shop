					...
					<c:forEach items="${shoppingCart.list}" var="domain">
								...
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															...
															<div class="price-line"> 
																<em class="J_Price price-now" id="priceNow" tabindex="0">${domain.goods_price}</em>
															</div>
														</div>
													</div>
												</li>
												...
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															...
															<input class="text_box" id="count" type="text" value="${domain.count}" 
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number" id="singlePrice"><fmt:formatNumber type="number" value="${domain.count*domain.goods_price}" maxFractionDigits="2"/></em>
												</div>
											</li>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee"><fmt:formatNumber type="number" value="${shoppingCart.price}" maxFractionDigits="2"/></em>
											</span>
										</div>
