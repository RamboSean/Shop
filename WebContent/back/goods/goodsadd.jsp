...
<script type="">
	$(function(){
		$("#goods_parentid").change(function(){
			//大类进行选中后，到达后台，联动将小类数据显示出来
			debugger
            var valueId = $(this).val();
			var param = new Object();
            param.id = valueId;  //{id:"35"}
            //异步处理
			$.get("GoodsInfoServlet?action=getSmall",param,function(data){
				debugger
				var arr = eval(data);  //将字符串内容变为js的数据
				var text = "";
...
<body>
    ...
    <form action="GoodsInfoServlet?action=addGoodsInfo" method="post" enctype="multipart/form-data">
    	<ul class="forminfo">
